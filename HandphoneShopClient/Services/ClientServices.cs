...
namespace HandphoneShopClient.Services
{
    public class ClientServices(HttpClient httpClient) : IProduct
    {
        ...
        private static StringContent GenerateStringContent(string serializedObj)=>new StringContent(serializedObj,System.Text.Encoding.UTF8,"application/json");
